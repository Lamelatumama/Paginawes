...
<body>
    ...
    <div class="main-content">
        <div class="reservation-container">
            ...
            <div id="error-message" class="error-message">
                <p>No podemos atender la reserva.</p>
                <p>Para gestionar esta reserva llamenos al telefono que ponemos a continuación</p>
                <p>Teléfono: +123 456 789</p>
                <button onclick="hideError()">BUSCAR EN OTRAS FECHAS</button>
    ...
    <script>
        ...
        let selectedTime = ''; // Variable global para almacenar la hora seleccionada
        let currentMonthIndex = 5; // Junio
        let currentYear = 2025; // Año actual
        ...
        function formatDate(dateText) {
            ...
            const monthMap = {
                "JUN": "06",
                // Añade otros meses según sea necesario
            };
        ...
        function nextMonth() {
            if (isFutureConfirmation) {
                return; // No hacer nada si ya estamos en "Próximas Confirmaciones"
            }
        ...
        // Asegúrate de que el botón de continuar llame a esta función
